...
class GameRepositoryImpl (
    ...
    override suspend fun createNewGame(
        ...
        when (val updateSettingsStorageResult = settingsStorage.updateSettings(settings)){
            ...
            is SettingsStorageResult.OnError -> onError(updateSettingsStorageResult.exception)
